...
class S1(tk.Frame):
    def __init__(self, master):
        ...
        self.login_button = Button(master, text="Log in with Google", width=50, image=self.image, command=lambda: master.switch_frame(S2) if connect() else self.login_error())
